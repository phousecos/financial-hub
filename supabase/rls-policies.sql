...
DROP POLICY IF EXISTS "Allow all inserts to email_logs" ON email_logs;
DROP POLICY IF EXISTS "Allow all reads to email_logs" ON email_logs;
DROP POLICY IF EXISTS "Allow all updates to email_logs" ON email_logs;
DROP POLICY IF EXISTS "Allow all deletes to email_logs" ON email_logs;
DROP POLICY IF EXISTS "Enable insert for all users" ON email_logs;
DROP POLICY IF EXISTS "Enable read access for all users" ON email_logs;
DROP POLICY IF EXISTS "Enable update for all users" ON email_logs;
DROP POLICY IF EXISTS "Enable delete for all users" ON email_logs;
...
-- ============================================
-- The Drive processor and Email worker use the service role key,
